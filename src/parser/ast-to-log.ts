import {
    AcquireCardActionContext, AcquiredToHandEffectContext, AcquiredToTheTopOfDeckEffectContext,
    ActionContext, ActionLineContext, ActivateCardActionContext, AddAuthorityContext,
    AddCombatContext, AddTradeContext, AttackBaseActionContext, AttackPlayerActionContext,
    AuthorityChangeContext, CardContext, CardToOpponentEffectContext, CardToOwnerEffectContext,
    ChangedCardToCardContext, ChangedToOnTableImageContext, ChoseActionContext, CombatChangeContext,
    DestroyedBaseEffectContext, DiscardCardActionContext, DiscardChangeContext,
    DiscardedCardEffectContext, DrewCardsEffectContext, EffectContext, EffectLineContext,
    EndTurnActionContext, GenericResolveActionContext, LineContext, NoDiscardCardActionContext,
    NoMoreCardsToDiscardEffectContext, NoScrapObjectCardActionContext, PlayAllCardsActionContext,
    PlayOneCardActionContext, RefreshedAllyIndicatorsEffectContext, ResolveDiscardActionContext,
    ResolveDiscardAndRedrawActionContext, ReturnCardActionContext, RevealedEffectContext,
    RevealedEventEffectContext, ScrapObjectCardActionContext, ScrappedCardEffectContext,
    ScrapSubjectCardActionContext, SelectCardActionContext, ShuffledEffectContext,
    SideEffectContext, SignedNumContext, StartContext, TradeChangeContext, TurnChangedEffectContext,
    WonGameEffectContext, WordContext
} from 'antlr-generated/LogParser'
import LogVisitor from 'antlr-generated/LogVisitor'
import { Log } from 'log'
import {
    AcquireCardAction, Action, ActivateCardAction, AttackBaseAction, AttackPlayerAction,
    ChoseAction, DiscardCardAction, EndTurnAction, GenericResolveAction, NoDiscardCardAction,
    NoScrapObjectCardAction, PlayAllCardsAction, PlayOneCardAction, ResolveDiscardAction,
    ResolveDiscardAndRedrawAction, ReturnCardAction, ScrapObjectCardAction, ScrapSubjectCardAction,
    SelectCardAction
} from 'log/actions'
import {
    AcquiredToHandEffect, AcquiredToTheTopOfDeckEffect, CardToOpponentEffect, CardToOwnerEffect,
    ChangedCardToCardEffect, ChangedToOnTableImageEffect, DestroyedBaseEffect, DiscardedCardEffect,
    DrewCardsEffect, Effect, NoMoreCardsToDiscardEffect, RefreshedAllyIndicatorsEffect,
    RevealedEffect, RevealedEventEffect, ScrappedCardEffect, ShuffledEffect, SideEffect, StatChange,
    TurnChangedEffect, WonGameEffect
} from 'log/effects'
